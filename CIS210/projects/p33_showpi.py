...
python while also providing a graphic visual using
the turtle function.
'''
...
def showMontePi(numDarts):
    ...
    total number of points along with plotting the
    points to visually show whether they are witin
    the circle or not.
...
def drawBoard():
    ...
    This function draws a graph for which we can plot our
    points
