...
class Test_Signed_Extraction(unittest.TestCase):
    ...
    def test_extract_neg(self):
        ...
        x = bitfield.extract_signed(field_bits)
...
class Test_Middle_Field(unittest.TestCase):

    def test_extract_insert(self):
        middle_bits = BitField(3,5)
        x = middle_bits.extract(0b101101101)
        y = middle_bits.insert(x, 0b101000101)
        self.assertEqual(y, 0b101101101)

    def test_insert_extract(self):
        middle_bits = BitField(3,5)
        x = middle_bits.insert(0b111, 0b111000101)
        self.assertEqual(middle_bits.extract(x), 0b111)
